...
- **Supersedes:** the "qualifier / evaluator certification" frame (an internal pre-launch plan, since reverted)
...
- Reverted work: an internal pre-launch qualifier subsystem (~1944 lines), reverted in full.
- Retrospective consult (2026-06): "slightly over-corrected; add the bounded six-case judge_canary."
- A dev probe suite was also removed pre-launch for the same reason.
